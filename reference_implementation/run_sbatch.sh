...
if [ ${8} == 1 ]; then
    ...
    sbatch -A pacer -N 1 -t 02:00:00 -p ${1} --gres=gpu:${2} --reservation=milan -J GC_p${1}_ng${2}_nc${3}_vng${4}_n${5}_nl${6} -o ../../../logs/GraphChallenge/sbatch/out_p${1}_ng${2}_nc${3}_vng${4}_n${5}_nl${6}.txt -e ../../../logs/GraphChallenge/sbatch/err_p${1}_ng${2}_nc${3}_vng${4}_n${5}_nl${6}.txt run.sh ${1} ${2} ${3} ${4} ${5} ${6} ${7}
fi