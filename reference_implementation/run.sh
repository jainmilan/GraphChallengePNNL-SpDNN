...
if [ ${7} == 1 ]; then
    ...
    mpirun -np ${2} python -u -m mpi4py ${PWD}/SparseDNN/python/${4}/runSparseDNNchallenge.py --neurons ${5} --num_layers ${6}
    # mpiexec -n ${2} python -u -m mpi4py ${PWD}/SparseDNN/python/${4}/runSparseDNNchallenge.py --neurons ${5} --num_layers ${6}
elif [ ${7} == 3 ]; then
    nsys profile --kill=none -t cuda,osrt,cudnn,cublas -o ../../../logs/GraphChallenge/nsys/qdrep_report_p${1}_ng${2}_nc${3}_vng${4}_n${5}_nl${6} -w true --force-overwrite=true mpirun -np ${2} python -u ${PWD}/SparseDNN/python/${4}/runSparseDNNchallenge.py --neurons ${5} --num_layers ${6}
elif [ ${7} == 5 ]; then
    mpirun -np ${2} python -u osu_latency.py
fi
# 
